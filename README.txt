...
a persistence unit "api_bancaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "api_banca/pom.xml":
...
artifact ("api_banca.war") is already built. You can build
